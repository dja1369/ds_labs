...
run_id: 2026-07-17T04-38-09Z-4443e76a
environment:
  arch: aarch64
  cpu_cores: 2
  memory_gb: 3.8
...
(값은 스텝당 3회 반복의 중앙값. 반복별 범위는 [`results/results.json`]({{ '/assets/data/2026-07-15-redis-blocking-threshold/results.json' | relative_url }})의
`note` 필드 참고.)
...
![runner_cpu_utilization_pct]({{ '/assets/images/2026-07-15-redis-blocking-threshold/runner_cpu_utilization_pct.png' | relative_url }})
